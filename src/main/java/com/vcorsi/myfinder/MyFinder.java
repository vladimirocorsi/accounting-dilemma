...
/**
 * This class holds a list of BigDecimal values and allows to search for a
 * solution to the Account Dilemma problem.
 * 
 * @author vladimiro
 * 
 */
class MyFinder implements Finder {
	 ...
	 */
	MyFinder(final BigDecimal[] values, final BigDecimal sum) {
		if (values == null) {
